...
type MessageCategory = "Sales" | "Support" | "Promotions";
...
export default function MessagesPage() {
  ...
  const [filter, setFilter] = useState<"All" | "Unread" | MessageCategory>("All");
    ...
    <section className="page-stack gap-4">
      <header className="rounded-2xl border border-amber-100 bg-white p-4">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {(["All", "Unread", "Sales", "Support", "Promotions"] as const).map((item) => (
            <button
              key={item}
